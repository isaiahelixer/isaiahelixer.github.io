...
![schematic](https://drive.google.com/file/d/1a4OAKZrk6LRnWvmBonQYlOflql5_qynn/view?usp=sharing){style width:"350" height:"300;"}
**Figure 1:** Showing the sensors, microcontroller, and power delivery schematic.


## Resouces

The schematic as a PDF download is available [*here*](https://drive.google.com/file/d/1a4OAKZrk6LRnWvmBonQYlOflql5_qynn/view?usp=sharing), and the Zip folder of the project [*here*](dummyZip.zip).
