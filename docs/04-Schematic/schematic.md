...
![Subsystem Schematic Design_page-0001](https://github.com/user-attachments/assets/e21d13dd-ad95-4eea-88aa-93921622d490)

## Resources

The schematic as a PDF download is available [*here*](https://github.com/user-attachments/files/23403058/Subsystem.Schematic.Design.pdf), and the Zip folder of the project [*here*](https://github.com/user-attachments/files/23380843/Sensor.SubSystem.zip)
